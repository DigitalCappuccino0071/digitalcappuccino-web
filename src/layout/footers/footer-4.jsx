...
const footer_contents = {
    ...
    subscribe_text: (
        <>
            To keep up to date with what&apos;s advanced and make informed
            choices about the services we offer, subscribe to our newsletter.
        </>
    ),
    copy_right_text: (
        <>
            © Copyright ©{new Date().getFullYear()} Digital Cappuccino. All
                                ...
                                >
                                    ...
                                    >
                                        <div className="tp-footer-widget__title pb-15">
                                            <h3 className="footer-title text-black">
                                                {title}
                                            </h3>
                                        </div>

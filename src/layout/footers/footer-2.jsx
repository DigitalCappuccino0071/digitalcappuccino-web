...
const footer_contents = {
  ...
  text: 'Digital Cappuccino is the digital marketing partner for all businesses looking forward to playing with' +
      ' online media and growing their businesses with successive results.',
  btn_text: 'Contact us',
  ...
  social_links: [
    {icon: 'fab fa-instagram',link: 'https://www.instagram.com/digitalcappuccino/' },
       {icon: 'fab fa-linkedin-in',link: 'https://www.linkedin.com/company/digital-cappuccino/' },
    {icon: 'fab fa-youtube',link: 'https://www.youtube.com/channel/UCPo5vk6L7UrnQcJ5faDdT0Q' },
    {icon: 'fab fa-twetter',link: 'https://twitter.com/Digicappuccino' },
  ],
}

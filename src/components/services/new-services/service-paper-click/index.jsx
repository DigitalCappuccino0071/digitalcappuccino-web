...
const ServicePaperClick = () => {
  ...
  return (
    <Wrapper>
      <Head>
        <title>PPC company in Gurgaon | PPC services in Gurgaon</title>
        <meta
          name="description"
        ...
        <meta
          property="og:title"
          content="PPC company in Gurgaon | PPC services in Gurgaon"
        />
        <meta
          ...
          __html: JSON.stringify([
            {
              ...
              '@type': 'WebPage',
              '@id':
                'https://www.digitalcappuccino.com/ppc-marketing-company-gurgaon#webpage',

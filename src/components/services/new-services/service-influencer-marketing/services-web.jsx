...
import services_data_digital_marketing, {
    services_data_influencer_marketing,
} from "../../../../data/services-data-digital-marketing";

const services_items = services_data_influencer_marketing.filter(
    (ser) => ser.service_p_4
);

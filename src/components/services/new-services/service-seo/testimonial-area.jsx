...
const testimonial_contents = {
  ...
  title: 'Client Testimonials Building trust through shared experiences',
  ...
  testimonial_data: [
    ...
    },
    {
      ...
      ratings: [1, 2, 3, 4, 5],
      desc: "They ran my Youtube ads and monetized my channel within a month. They are " +
          "doing an amazing job and have some cool digital marketing services in Mumbai. I highly recommend and advise others and my friends.",
    ...
    },
    {
      ...
      brand_img: '/assets/img/testimonial/testi-brands-1.png',
      ratings: [1, 2, 3, 4, 5],
      desc: 'Digital marketing consists of many things; frankly speaking, I knew none. Digital Cappuccino made it very specific in the beginning that they are always open to communicating and building a ' +
          'marketing strategy that defines my business which they did.',
      img: '/assets/img/testimonial/testi-4.2.png',
      name: 'Sarthak Patel',
      title: 'P. Desiger of (Amazon)'
    }
...
const TestimonialArea = ({ home_6, style_2 = false }) => {
  ...
  return (
    <div className={`tp-testimonial-area ${style_2 ? 'pb-30' : 'pt-130 pb-130'} p-relative`}>
      ...
      <div className="container">
        <div className="row">
          <div className="col-xl-12">
            <div className="tp-testi-wrapper d-flex pb-30 justify-content-between align-items-end">
              <div className="tp-testimonial-title-box ">
                <h5 className="tp-subtitle">{ subtitle}</h5>
                <h2 className="tp-title-sm">{ title}{ highlight_text}</h2>
              </div>
            </div>
          </div>
        </div>

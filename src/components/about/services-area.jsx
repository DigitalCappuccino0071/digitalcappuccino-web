        ...
        <div className="container ac-chose-bg">
          <div className="row">
            <ChoseItem duration='.3s' delay='.5s' icon='flaticon-group' title={<>Professional <br /> Team</>}
              text={'15+ Team Member'} />
            <ChoseItem duration='.5s' delay='.7s' item_num={'tpchosebox-three'} color="fea-color-5" icon='fas fa-star' title={<>Competitive <br /> Rate</>} text={'100% Commitment'} />
            <ChoseItem duration='.7s' delay='.9s' item_num={'tpchosebox-two'} color="fea-color-4" icon='flaticon-web' title={<>Google Certified  <br />Team</>} text={'100% Precision'} />
            <ChoseItem duration='.9s' delay='1s' icon='fas fa-star' title={<>Budgeting <br /> Expert</>}
              text={'15+ Cr. Managed'} />
          </div>
        </div>
      </div>
